...
contracts_router = routers.NestedSimpleRouter(clients_router, r"client/?", lookup="project")
contracts_router.register(r"contracts/?", ContractViewSet, basename="contracts")

events_router = routers.NestedSimpleRouter(contracts_router, r"contracts/?", lookup='contracts')
